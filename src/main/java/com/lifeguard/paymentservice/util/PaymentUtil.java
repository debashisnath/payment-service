...
public class PaymentUtil {
    ...
    private static final String paymentKey = "qCTvx2aX";

    private static final String paymentSalt = "D63oGJGTXf";
    ...
    public static PaymentDetail populatePaymentDetail(PaymentDetail paymentDetail){
        ...
        hashString = hashString.replace("phone", paymentDetail.getPhone());
